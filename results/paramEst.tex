...
parameterization is 0.038\textpm0.019, which makes the estimated value of $\lamsAbs$\textapprox1\textminus$\Cs$ equal to 0.963\textpm0.019.
Since the estimates of $\phis$ and $\lamsAbs$ are almost uncorrelated, the effect of assuming $\lamsAbs$\texteq1 on the $\phis$ estimate is
negligible.
