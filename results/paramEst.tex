...
probability to find values further from zero than the measurement is only 97\%. Comparing with $\phisav$\texteq\tm2$\bs$ instead of
...
$\phis$/$\lamsAbs$\texteq1 parameterizations the estimates of the values of these parameters are very similar. Fixing the value of
$\lamsAbs$ does make the uncertainties with the $\phis$/$\lamsAbs$\texteq1 parameterization smaller, because of the correlations with this
