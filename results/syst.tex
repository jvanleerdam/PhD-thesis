...
Other nuisance parameters constrained by external measurements are the parameters that describe the flavour-tagging calibration, as
discussed in Section~\ref{subsec:ana_tagging_impl}. Fixing the tagging parameters does not significantly affect any of the uncertainty
