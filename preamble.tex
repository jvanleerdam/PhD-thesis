...
\newcommand{\phisav}{\phis^\text{av}}
\newcommand{\Delphispara}{\Delta\phis^\parallel}
\newcommand{\Delphisperp}{\Delta\phis^\perp}
\newcommand{\Delphisperpp}{\Delta\phis^{\perp\prime}}
\newcommand{\DelphisS}{\Delta\phis^\text{S}}
...
\newcommand{\DelCspara}{\Cs^\parallel}
\newcommand{\DelCsperp}{\Cs^\perp}
...
\newcommand{\magzeroAvSq}{\Azero^{\text{av}2}}
\newcommand{\magpar}{|\Apar|}
\newcommand{\magparSq}{\magpar^2}
\newcommand{\magparAvSq}{\Apar^{\text{av}2}}
\newcommand{\magperp}{|\Aperp|}
\newcommand{\magperpSq}{\magperp^2}
\newcommand{\magperpAvSq}{\Aperp^{\text{av}2}}
\newcommand{\magS}[1][]{|A_\text{S#1}|}
\newcommand{\magSAvSq}[1][]{\AS[#1]^{\text{av}2}}
\newcommand{\FS}[1][]{F_\text{S#1}}
\newcommand{\FSAv}[1][]{\FS[#1]^\text{av}}
\newcommand{\delzero}{\delta_0}
\newcommand{\delpar}{\delta_\parallel}
...
\newcommand{\delSperp}[1][]{\delS[#1]\,\text{--}\,\delperp}
