...
\usepackage{bm}
\usepackage[colorlinks,linkcolor=black,citecolor=black,filecolor=black,urlcolor=black,plainpages=false]{hyperref}
...
\newcommand{\BstoJpsimumuphiKK}{$\Bs \to \Jpsi(\to\mumu)\,\upphi(\to\KK)$}
...
\newcommand{\BH}{\text{B}_\text{s,H}^0}
\newcommand{\BL}{\text{B}_\text{s,L}^0}
\newcommand{\BE}{\text{B}_\text{s,E}^0}
\newcommand{\BO}{\text{B}_\text{s,O}^0}
...
\newcommand{\lamAbs}{|\lambda|}
\newcommand{\lamSq}{\lamAbs^2}
\newcommand{\Gam}{\Gamma_\text{s}}
\newcommand{\DelGam}{\Delta\Gamma_\text{s}}
\newcommand{\Delm}{\Delta m_\text{s}}
\newcommand{\eGt}{e^{-\Gam\,t}}
\newcommand{\eGtal}{e^{-\Gam\,\alert{t}}}
\newcommand{\cDG}{\cosh\left(\tfrac{1}{2}\DelGam\, t\right)}
\newcommand{\cDGal}{\cosh\left(\tfrac{1}{2}\DelGam\, \alert{t}\right)}
\newcommand{\sDG}{\sinh\left(\tfrac{1}{2}\DelGam\, t\right)}
\newcommand{\sDGal}{\sinh\left(\tfrac{1}{2}\DelGam\, \alert{t}\right)}
\newcommand{\cDm}{\cos\left(\Delm\, t\right)}
\newcommand{\cDmal}{\cos\left(\Delm\, \alert{t}\right)}
\newcommand{\sDm}{\sin\left(\Delm\, t\right)}
\newcommand{\sDmal}{\sin\left(\Delm\, \alert{t}\right)}
...
\newcommand{\AbarA}[1][i]{\tfrac{\overline{A}_{#1}}{A_{#1}}}
