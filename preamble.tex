...
\newcommand{\magAv}[1][\Ai]{#1^{\text{CP}}}
\newcommand{\magAvConj}[1][\Ai]{{\magAv[#1]}^\ast}
\newcommand{\magzero}{|\Azero|}
\newcommand{\magzeroSq}{\magzero^2}
\newcommand{\magzeroAvSq}{|\magAv[\Azero]|^2}
\newcommand{\magpar}{|\Apar|}
\newcommand{\magparSq}{\magpar^2}
\newcommand{\magparAvSq}{|\magAv[\Apar]|^2}
\newcommand{\magperp}{|\Aperp|}
\newcommand{\magperpSq}{\magperp^2}
\newcommand{\magperpAvSq}{|\magAv[\Aperp]|^2}
\newcommand{\magS}[1][]{|A_\text{S#1}|}
\newcommand{\magSAvSq}[1][]{|\magAv[\AS[#1]]|^2}
