...
\begin{tikzpicture}[scale=4]
  \begin{scope}[>=latex]
    ...
    % angles
    \draw [black] (apex)   +(-37:0.09) arc (-37:-127:0.09); % α: 90 degrees
    \draw [black] (unity)  +(180:0.17) arc (180:143:0.17);  % β: 37 degrees
    \draw [black] (origin) +(0:0.10)   arc (0:53:0.10);     % γ: 53 degrees
