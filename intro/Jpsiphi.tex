...
\begin{figure}[hbt]
  ...
  \begin{subfigure}{0.5\textwidth}
    \centering
    {\sffamily \input{graphics/intro/box1/box1}}
    \caption{}
    \label{fig:mixing_1}
  \end{subfigure}%
  \begin{subfigure}{0.5\textwidth}
    \centering
    {\sffamily \input{graphics/intro/box2/box2}}
    \caption{}
    \label{fig:mixing_2}
  \end{subfigure}
...
mean lifetimes (see Section~\ref{sec:pheno_mix}). A particle that is created as $\Bs$ can at a later point in time be observed as either a
$\Bs$ or a $\Bsbar$. As a result, the distribution of the time at which the \BsBsbar{} system decays is not a simple exponential, as it
would be in the absence of mixing. Because the expression for the probability to observe the system as a $\Bs$ or a $\Bsbar$ as a function
of time contains sinusoidal terms, mixing is often referred to as ``\BsBsbar{} oscillations''.
...
\begin{figure}[hbt]
  ...
  \begin{subfigure}{0.5\textwidth}
    \centering
    {\sffamily \input{graphics/intro/tree/tree}}
    \caption{}
    \label{fig:decay_tree}
  \end{subfigure}%
  \begin{subfigure}{0.5\textwidth}
    \centering
    {\sffamily \input{graphics/intro/penguin/penguin}}
    \caption{}
...
For both of the $\fzero$ and non-resonant contributions the $\KK$ system is in a state of zero orbital angular momentum and hence these
contributions are commonly referred to as the \emph{$\KK$ S-wave}. Because the $\Jpsiphi$ and $\KK$ S-wave processes are observed
simultaneously in a measurement, the analysed decay is referred to as \BstoJpsiKK.

In addition to separating the three components of the \BstoJpsiphi{} process, these components are also separated from the S-wave
