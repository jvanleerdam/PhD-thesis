...
resolve oscillations in decay-time distributions with a frequency $\Dms$\textapprox18\unitsp{}ps. Another important feature of the detector
...
Figure~\ref{fig:event} shows the information from the different subdetectors for an event that contains a \BstoJpsiKK{} decay candidate.
