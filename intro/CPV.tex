...
\begin{figure}[hbt]
  {\sffamily \input{graphics/intro/WCouplings/WCouplings}}
...
Figure~\ref{fig:unitTriangleMeas} shows the resulting CKMfitter unitarity triangles, together with the constrains on the coordinates
