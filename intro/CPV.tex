...
magnitudes of which are squared to obtain the corresponding observable probability. The magnitude of a single CKM-matrix element is the
same as the magnitude of its complex conjugate. Furthermore, the appearance of imaginary parts of CKM elements is convention dependent. A
single element can be made real by rotating the phases of the quark fields.
...
triangle from the measurements that are input to the fit.
...
CP-violation measurements with \BstoJpsiphi{} have been performed previously by the D0 \cite{Abazov:2011ry}, CDF \cite{Aaltonen:2012ie},
\textsc{Atlas} \cite{Aad:2012kba,*ATLAS:2013nla}, and LHCb \cite{LHCb-PAPER-2013-002} experiments. These measurements and their combination
\cite{Amhis:2012bh} are compatible with no CP violation and also with the value of $\bs$ from the Standard Model fit
(Equations~\ref{eq:CKMAnglesCKMf} and \ref{eq:CKMAnglesUTf}). More precise measurements are needed to draw conclusions on possible
