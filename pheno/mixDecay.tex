...
Mass and decay parameters of $\Bs$ and $\Bsbar$ are related to the masses and decay widths of the diagonalized $\BL$ and $\BH$ states by
...
With the parameter $\Cm$, the factors $\pqAbsAlt^2$ and $\qpAbsAlt^2$ for the $\Bsbartof$ and $\Bstofbar$ decay rates, respectively, are
given by
\begin{equation}
  \label{eq:CmpqqpSq}
...
in the ratio $\gmmixAlt$\textapprox5\tenpowmult{--3} for the parameters $\qp$, $\Dms$, and $\DGs$. Starting from Equations~\ref{eq:qpDef},
...
$\phimix$\texteq0.0038\textpm0.0010\unitsp{}rad~\cite{Lenz:2006hd,*Lenz:2011ti}. With Equations~\ref{eq:CmDef} and
