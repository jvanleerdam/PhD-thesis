...
To simplify the analysis of the time and angular distributions, the model for the \BstoJpsiKK{} decay is integrated over the $\KK$ mass.
This integral gives a factor for each term in Equation~\ref{eq:sqAmp}, which is, in principle, different for each combination of
...
Equation~\ref{eq:diffRateAngles}. The dependence of this factor on $\mKK$ can be derived from kinematic relations and is given by
\begin{equation}
...
arbitrary and only phase differences can be observed. Integrating over $\mKK$, the phases $\kij$ can be absorbed into the phase
differences between the transversity amplitudes:
\begin{equation}
